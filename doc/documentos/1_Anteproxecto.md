...
O produto central ofrecido será un software xestor de datos dos clientes dos negocios que contraten os nosos servizos. No que poderán engadir, actualizar e eliminar os mesmos. Co aumentado, terán a posibilidade de descargar facturas dos traballos realizados, xestión de citas e/ou compras de produtos. Tamén se poderán engadir funcións adaptadas a cada negocio.  

O público obxectivo do produto son empresas pequenas en crecemento. Empresas que carecen dun software adaptado ás súas necesidades concretas e que non precisan dun gran software para a súa xestión, con centos de funcións que non chegarían a aproveitar.  

O produto será ofrecido ós comerciantes da zona, unha vez feita a primeira aplicación, para que os potenciales clientes poidan ver o produto que ofrece a empresa de primeira man.  

Tamén colocando carteis publicitarios nas distintas asociociación de empresarios e comerciantes da zona e alrededores. Como a idea e que sexa un softaware personalizado, podería adaptarse a case calquer negocio pequeno que careza dun software adaptado. Unha vez aumentada a carteira de clientes e, polo tanto os ingresos, contrataríase unha empresa de márketing para realizar as tarefas de publicidade.   
...
Hai negocios que non precisan dun gran software de xestión con centos de funcións. Pero sí dun programa ó que poidan ecceder dende o centro de traballo e desde o seu teléfono, por exemplo. Iso é o que ofrecemos: as funcións que precisen en cada momento e, si requiren mais, ir engadíndoas.

### 2.6- Forma xurídica
  
Sociedad de Responsabilidad Limitada(S.L/S.R.L): Elixida tanto, polo número de socios necesarios -ainda que traballe unha soa persoa nos comezos do negocio vai haber máis socios, como mínimo un- como polo capital mínimo necesario para levar a cabo a constitución da empresa. Tamén pola vantaxe de poder responder únicamente cos bens da empresa e non cos propios.  
...
- Tarifa mensual emprego sofware mellorado: 80€/mes
- Tarifa mensual emprego sofware avanzado: 100€/mes
- Tarifa mensual emprego sofware premium: 120€/mes
- Formación: 20€/h    
...
Reflexión: Terían que multiplicarse por 10 os ingresos para que o umbral de rentabilidade sexa positivo. O que significa que sería necesario chegar a uns 10 clientes mais de media.

Tendo en conta todo isto, e analizando os datos dos primeiros meses do negocio: cuns custos fixos mensuais duns 2700€, un investimento de 1680€ e uns ingresos de 940€ o negocio non sería viable no caso de non conseguir chegar a mais clientes.

#### 2.8.3- Conclusión
 
O negocio sería viable sempre e cando se consiga chegar a mais clientes, en caso contrario non.
  
Os beneficios, de levar a cabo o primeiro proxecto, son inferiores ós costes e á inversión incial. Mais, é necesario realizalo para que poida servir de escaparate para chegar a novos clientes o antes posible.  
